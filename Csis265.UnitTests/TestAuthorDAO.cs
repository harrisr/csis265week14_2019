    ...
    public class TestAuthorDAO
    {
        ...
        public void TestAuthorDAOSelectOne()
        {
            ...
            try
            {
                ...
                Author filter = new Author(1, "BLANK", "BLANK", DateTime.Now);
        ...
        public void TestAuthorDAOInsertOne()
        {
            ...
            try
            {
                ...
                Author newAuthor = new Author(-1, "Larry Niven", "Larry@Niven.com", DateTime.Now);
        ...
        public void TestAuthorDAODeleteOne()
        {
            ...
            try
            {
                ...
                Author temp = new Author(2, "BLANK", "BLANK", DateTime.Now);
